                  ...
                  <TableBody>
                    {pendingUsers.map((user) => (
                      <TableRow key={user.id}>
                        ...
                        <TableCell className="text-gray-500 font-mono text-xs">{user.createdAt}</TableCell>
                        <TableCell>
                ...
                <TableBody>
                  {activeUsers.map((user) => (
                    <TableRow key={user.id}>
                      ...
                      <TableCell className="text-gray-500 font-mono text-xs">{user.lastLoginAt ?? "—"}</TableCell>
                      <TableCell>
                        <select
                          value={user.role}
